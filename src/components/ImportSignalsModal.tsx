...
const COL_MAP: Record<string, keyof BaySignal> = {
  ...
  'iec61850_do': 'iec61850_do', 'doname': 'iec61850_do', 'do': 'iec61850_do',
  'iec61850_da': 'iec61850_da', 'daname': 'iec61850_da', 'da': 'iec61850_da',
...
function parseRow(raw: Record<string, unknown>, phase: ProjectPhase, libraryIndex?: Map<string, SignalLibraryEntry>): ParsedRow {
  ...
  const data: BaySignal = {
    ...
    iec61850_do: str(mapped.iec61850_do),
    iec61850_da: str(mapped.iec61850_da),
